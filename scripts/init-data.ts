...
async function initData() {
    ...
    const minecraftVersion: string = existingVersion ?? (versionData?.id as string | undefined) ?? "unknown";
    ...
    console.log(`Done. Wrote ${Object.keys(newItems).length} items to items.json (version: ${minecraftVersion}).`);
}
