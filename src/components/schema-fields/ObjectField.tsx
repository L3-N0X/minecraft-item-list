...
export function ObjectField({
    ...
    const parentRequired: string[] | undefined = Array.isArray(
            ...
            <div className="md:col-span-2 flex items-center gap-3 py-1">
                ...
                <Button
                    ...
                    className={cn(
                        ...
                        validationRingClass(childValidationEntry)
                    )}
            ...
            <div className="flex items-center gap-2">
                ...
                {childValidationEntry && (
                    <span
                        className={cn(
                            'text-xs font-normal',
                            childValidationEntry.severity === 'error'
                                ? 'text-red-400'
                                : 'text-yellow-500/90'
                        )}
                    >
