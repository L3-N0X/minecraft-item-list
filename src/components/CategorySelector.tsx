    ...
    return (
        <div className="space-y-3">
            <div className="flex flex-wrap gap-1">
                ...
                {selectedCategories.length === 0 && <span className="text-sm text-muted-foreground">No categories selected</span>}
            </div>
            ...
            <Popover open={open} onOpenChange={setOpen}>
                ...
                <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0">
                    <Command>
                        ...
                        <CommandList>
                            <CommandEmpty>
                                <Button variant="ghost" className="w-full justify-start text-left" onClick={handleAddNew}>
                                    <Plus className="mr-2 h-4 w-4" />
                                    Create "{inputValue}"
                                </Button>
                            </CommandEmpty>
                            {inputValue.trim() && !categoryNames.includes(inputValue.trim()) && (
                                <>
                                    <CommandGroup>
