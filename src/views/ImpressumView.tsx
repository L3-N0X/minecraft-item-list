                    ...
                    <div className="px-6 py-6 space-y-6">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground mb-4">
                                Information pursuant to § 5 DDG (Angaben gemäß §
                                5 DDG)
                            </p>
                        ...
                        <div>
                            <h3 className="text-lg font-semibold mb-2 text-foreground">
                                Responsible for content (Verantwortlich für den
                                Inhalt)
                            </h3>
                            <address className="not-italic text-foreground/90 space-y-1">
                                <div className="font-semibold">Leon Gött</div>
                ...
                <GlassPanel className="w-full">
                    <div className="px-6 py-6 space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-foreground/90 mb-3">
                                This website is hosted on GitHub Pages. The
                                provider is GitHub Inc., 88 Colin P Kelly Jr St,
                                San Francisco, CA 94107, USA.
                            </p>
                            <p className="text-foreground/90 mb-3">
                                When you visit this website, GitHub
                                automatically collects and stores information in
                            ...
                            <p className="text-foreground/90 mb-3">
                                ...
                                6(1)(f) GDPR (Datenschutz-Grundverordnung). The
                                website operator has a legitimate interest in
                                the technically error-free presentation and
                                optimization of the website – for this purpose,
                                the server log files must be recorded by the
                                hosting provider.
                            </p>
                            <p className="text-foreground/90">
                                For more information on how GitHub handles user
                                data, please refer to the GitHub Privacy
                                Statement:{' '}
                                <a
